...
| Frame time | Open `/signal-garden/play/?sg-render=1920x1080&sg-stats=1`; keep the window foreground and visible through 5-second warmup and all 30 samples. Record the reported exact buffer, minimum and mean, build identity, and browser. | PASS_LOCAL — 30/30 samples, exact 1920×1080, 63.1 fps mean in-app; independent desktop browser remains open |
